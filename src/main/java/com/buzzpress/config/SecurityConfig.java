package com.buzzpress.config;

import com.buzzpress.security.RestAuthenticationEntryPoint;
import com.buzzpress.security.TokenAuthenticationFilter;
import com.buzzpress.security.oauth2.CustomOAuth2UserService;
import com.buzzpress.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/article/{\\d+}", "/articleMeta/{\\d+}", "/articleMeta", "/topUsers", "/user/{\\w+}");
    }
    @Override
