...
public class LoginController {
    ...
    public Users_ getCurrentUser(@CurrentUser UserPrincipal userPrincipal) {
    	// System.out.println(userPrincipal.getUserEmail()+" userId:"+userPrincipal.getUserId()+" " + " atributes:"+ userPrincipal.getAttributes()+ " authorities:"+ userPrincipal.getAuthorities());
